...
[`github.com/WuErPing/pkger`](https://godoc.org/github.com/WuErPing/pkger) is a tool for embedding static files into Go binaries. It will, hopefully, be a replacement for [`github.com/gobuffalo/packr/v2`](https://godoc.org/github.com/gobuffalo/packr/v2).
...
github.com/WuErPing/pkger:/cmd/pkger/main.go
...
```bash
$ go get github.com/WuErPing/pkger/cmd/pkger
$ pkger -h
```
...
To do this you may use either the [`github.com/WuErPing/pkger#Include`](https://godoc.org/github.com/WuErPing/pkger#Include) function to set a no-op parser directive to include the specified path.
...
The reference application for the `README` examples, as well as all testing, can be found at [https://github.com/WuErPing/pkger/tree/master/pkging/pkgtest/testdata/ref](https://github.com/WuErPing/pkger/tree/master/pkging/pkgtest/testdata/ref).
...
The two most important interfaces are [`github.com/WuErPing/pkger/pkging#Pkger`](https://godoc.org/github.com/WuErPing/pkger/pkging#Pkger) and [`github.com/WuErPing/pkger/pkging#File`](https://godoc.org/github.com/WuErPing/pkger/pkging#File).
...
The [`github.com/WuErPing/pkger/parser#Parser`](https://godoc.org/github.com/WuErPing/pkger/parser#Parser) works by statically analyzing the source code of your module using the [`go/parser`](https://godoc.org/go/parser) to find a selection of declarations.
...

{
 ".": [
  {
   "file": {
    "Abs": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref/foo/bar/baz",
    "Path": {
     "Pkg": "app",
     "Name": "/foo/bar/baz"
    },
    "Here": {
     "Dir": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref",
     "ImportPath": "app",
     "Module": {
      "Path": "app",
      "Main": true,
      "Dir": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref",
      "GoMod": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref/go.mod",
      "GoVersion": "1.13"
     },
     "Name": "main"
    }
   ...
   "pos": {
    "Filename": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref/main.go",
    "Offset": 629,
    "Line": 47,
    "Column": 27
   },
  ...
  {
   "file": {
    "Abs": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref/foo/bar/baz/biz.txt",
    "Path": {
     "Pkg": "app",
...

{
 ...
 "Files": [
  {
   "Abs": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref/assets",
   "Path": {
    "Pkg": "app",
    "Name": "/assets"
   },
   "Here": {
    "Dir": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref/assets",
    "ImportPath": "",
    "Module": {
     "Path": "app",
     "Main": true,
  ...
  {
   "Abs": "/go/src/github.com/WuErPing/pkger/pkging/pkgtest/testdata/ref/assets/css",
   "Path": {
    "Pkg": "app",
    "Name": "/assets/css"
   },
